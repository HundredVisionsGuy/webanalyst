...
def test_large_project_html_report_for_set_linked_stylesheets(
    ...
    expected = {
        "about.html": ["css/navigation.css", "css/general.css", "css/layout.css"],
        "gallery.html": ["css/navigation.css", "css/general.css", "css/layout.css"],
        "index.html": None,
    }
...
def test_extract_only_style_tags_from_css_files_for_large_project_css_report_gallery_page(
    large_project_css_report,
):
    html_files = large_project_css_report.project_css_by_html_file
    results = large_project_css_report.extract_only_style_tags_from_css_files(
