...
from webanalyst import clerk, report
...
def test_large_project_general_report_for_set_paragraphs(
    large_project_general_report,
):
...
def test_about_me_general_report_for_get_num_words(
    about_me_general_report, paragraph_tag
):
...
def test_general_report_for_analyze_results(
    about_me_general_report, large_project_general_report
):
...
def test_general_report_for_get_report_details_min_number_files(
    about_me_general_report,
):
...
def test_general_report_for_get_report_results_string_for_spp(
    about_me_general_report,
):
    spp_input = ["general-spp-results", "Avg. Sentences / Paragraph", "[1, 5]"]
...
def test_general_report_for_get_report_results_string_for_wps(
    about_me_general_report,
):
    wps_input = ["general-wps-results", "Avg. Words / Sentence", "[10, 20]"]
    actual = about_me_general_report.report_details["writing_goal_results"]
    results = report.Report.get_report_results_string(
        wps_input[0],
        wps_input[1],
...
def test_static_method_get_report_results_string_for_html(
    about_me_general_report,
):
...
def test_general_report_for_get_report_results_string_for_css(
    about_me_general_report,
):
...
def test_large_project_general_report_for_get_min_number_files_for_2_HTML(
    large_project_general_report,
):
...
def test_large_project_general_report_for_get_min_number_files_for_2_CSS(
    large_project_general_report,
):
...
def test_about_me_html_report_for_analyze_results_can_attain_level_property_change(
...
def test_large_project_html_report_for_analyze_results_can_attain_level_property_change(
    large_project_html_report,
):
...
def test_about_me_html_report_for_get_html_requirements_list(
    about_me_html_report,
):
...
def test_html_report_for_check_element_for_required_number(
    about_me_html_report,
):
...
def test_html_report_for_get_required_elements(
    about_me_html_report, about_me_required_elements
):
...
def test_html_report_for_set_required_elements_about_me_h1(
    about_me_html_report,
):
...
def test_html_report_for_set_required_elements_about_me_h2(
    about_me_html_report,
):
    about_me_html_report.set_required_elements_found()
...
def test_html_report_meets_htmle5_essential_requirements_for_false(
    about_me_dnm_html_report,
):
...
def test_html_report_for_get_validator_goals_return_value(
    about_me_html_report,
):
...
def test_html_report_for_get_validator_goals_to_set_details(
    about_me_html_report,
):
...
def test_large_project_html_report_for_get_validator_goals_return_value(
    large_project_html_report,
):
...
def test_large_project_html_report_for_get_validator_goals_to_set_details(
    large_project_html_report,
):
...
def test_large_project_html_report_for_set_linked_stylesheets(
    large_project_html_report,
):
    expected = {
        "about.html": [
...
def test_about_me_css_report_for_report_details_num_css_files(
    about_me_css_report,
):
...
def test_large_project_css_report_for_report_details_num_css_files(
    large_project_css_report,
):
...
def test_about_me_css_report_for_get_children_head(about_me_css_report):
    children = about_me_css_report.get_children(
        "tests\\test_files\\projects\\about_me\\index.html", "head"
    )
    assert len(children) == 4


def test_large_project_css_report_for_get_children_head(
    large_project_css_report,
):
    children = large_project_css_report.get_children(
        "tests\\test_files\\projects\\large_project\\gallery.html", "head"
    )
    assert len(children) == 9


def test_large_project_css_report_for_get_project_css_by_file(
    large_project_css_report,
):
    num_css_files = len(
        large_project_css_report.project_css_by_html_file["gallery.html"]
    )
...
def test_pages_contain_same_css_files_for_large_project_css_report_false(
    large_project_css_report,
):
...
def test_extract_only_style_tags_from_css_files_for_large_project_css_report_index_page(
    large_project_css_report,
):
    html_files = large_project_css_report.project_css_by_html_file
    results = large_project_css_report.extract_only_style_tags_from_css_files(
        html_files
    )
    assert len(results["index.html"]) == 0


def test_extract_only_style_tags_from_css_files_large_project_css_report_gallery_page(
    large_project_css_report,
):
    html_files = large_project_css_report.project_css_by_html_file
    results = large_project_css_report.extract_only_style_tags_from_css_files(
...
def test_extract_only_style_tags_from_css_files_for_large_project_css_report_about_page(
    large_project_css_report,
):
    html_files = large_project_css_report.project_css_by_html_file
    results = large_project_css_report.extract_only_style_tags_from_css_files(
...
def test_pages_contain_same_css_files_for_multipage_meets_project_true(
    multi_page_meets_css_report,
):
    assert multi_page_meets_css_report.pages_contain_same_css_files


def test_pages_contain_same_css_files_for_large_project_false(
    large_project_css_report,
):
    assert not large_project_css_report.pages_contain_same_css_files


def test_set_repeat_selectors_for_large_report_body_selector(
    large_project_css_report,
):
...
def test_set_repeat_selectors_for_large_report_body_selector_in_about_html(
    large_project_css_report,
):
    results = large_project_css_report.repeat_selectors["body"]
...
def test_get_implemented_selectors(large_project_css_report):
    ...
    implemented_selectors = large_project_css_report.get_implemented_selectors(
        selectors, filenames
    )
...
def test_get_repeated_selectors(large_project_css_report):
    repeated_selectors = {
        ".container": ["layout.css", "layout.css"],
...
def test_set_repeat_declaration_blocks(large_project_css_report):
    ...
    results = large_project_css_report.repeat_declarations_blocks[
        "{margin: 0;padding: 0;}"
    ]
    assert results == expected
...
def test_get_header_details_for_font_families_details(about_me_report):
    ...
    expected = {
        "title": "Font Families",
        "details": {"description": "number of font families to be set"},
    }
    assert results == expected
...
def test_about_me_html_report_for_general_results_in_report_html_doc_contents(
    about_me_html_report,
):
    report_contents = clerk.file_to_string(report_html_doc_path)
    report_tr = (
...
def test_about_me_html_report_for_html_results_in_report_html_doc_html_results_content(
    about_me_html_report,
):
    report_contents = clerk.file_to_string(report_html_doc_path)
